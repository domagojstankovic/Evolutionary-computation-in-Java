...
public class Evaluator implements IGAEvaluator<int[]> {
	...
	private GrayScaleImage template; // Slika koju se pokušava pogoditi/nacrtati
	private ImageProvider imgProvider;
	
	public Evaluator(GrayScaleImage template, ImageProvider imgProvider) {
		super();
...
//		System.out.println(Thread.currentThread().getName() + " --- " + im.toString());
		draw(p, im);
