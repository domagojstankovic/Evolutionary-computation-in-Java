...
//		int colorInterval = 20;
//		int sizeInterval = 30;
		//		IMutation mutation = new SmallChangesMutation(colorInterval, sizeInterval, imgWidth, imgHeight);
		
		double sigma = 5;
		IMutation mutation = new NormalMutation(sigma, imgWidth, imgHeight);

//		IOptAlgorithm alg = new PGA1(maxiter, pop, minFit, popSize, imgWidth, imgHeight, selection, crossover, mutation,
//				evaluator);
		
		IOptAlgorithm alg = new GA1(maxiter, pop, minFit, popSize, imgWidth, imgHeight, selection, crossover, mutation,
				evaluator);
